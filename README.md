...
| **[Ramnit_Lab](./02_Enpoint_Forensics/Ramnit_Lab_(Windows_log_Analysis).md)** | 🟡 **Endpoint Forensics** | Memory dump analysis: detection of a masked process, C2 communication. | Volatility3, T1036, T1204, T1071 |
